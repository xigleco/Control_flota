...
import logoCombustible from '/src/img/combustible.png';
    ...
    <div className="container-fluid">
      <div className="row">
        ...
        <main className="col-md-9 px-md-4" style={{ width: '100%' }}>
          ...
          <button className="btn btn-success mb-2 me-2" onClick={() => setMostrarFormulario(true)}>
            Gestion De Vehiculos
          </button>

          <button className="btn btn-success mb-2 me-2" title="Carga de Combustible">
          ...
          <AnimatePresence>
            ...
            <motion.div
              ...
              {mostrarFormulario && (
                <form id="formVehiculo" className="row g-3 py-4" onSubmit={handleSubmit}>
                  <div className="row">
                  ...
                  <div className="row">
                    <div className="col-md-4 mb-3">
                      ...
                      <input type="text" className="form-control" name="patente" value={form.patente} onChange={handleChange} required />
                    </div>
                    <div className="col-md-4 mb-3">
                  ...
                  <div className="row">
                    <div className="col-md-4 mb-3">
                      ...
                      <input type="text" className="form-control" name="anio" value={form.anio} onChange={handleChange} />
                    </div>
                    <div className="col-md-4 mb-3">
                      <label htmlFor="Kilometros">Kilometros</label>
                      <input type="text" className="form-control" name="Kilometros" value={form.Kilometros} onChange={handleChange} />
                    </div>
                    <div className="col-md-4 mb-3">
                  ...
                  <div className="mb-1">
                    <button type="submit" className="btn btn-success me-2">Guardar Vehículo</button>
                ...
                <div class="container">
                  <div class="row">
                    <div class="col-sm" style={{ width: '25%' }}>
                      <div><strong>Numero:</strong> {vehiculo.numero}</div>
                      <div><strong>Marca:</strong> {vehiculo.marca}</div>
                      <div><strong>Modelo:</strong> {vehiculo.modelo}</div>
                    </div>
                    <div class="col-sm" style={{ width: '25%' }}>
                      <div><strong>Kilómetros:</strong> {vehiculo.Kilometros}</div>
                      <div><strong>Tipo:</strong> {vehiculo.tipo}</div>
                      <div><strong>Consumo:</strong> {vehiculo.Combustible}</div>
                    </div>
                    <div class="col-sm" style={{ width: '25%' }}>
                      <img
                        src={vehiculo.imagen}
                    ...
                    <div className="d-flex justify-content-end align-items-center" style={{ width: '25%' }}>
                      <button
                        ...
                        onClick={() => {
                          const confirmar = window.confirm(`¿Estás seguro de que querés eliminar el vehículo con ID ${vehiculo.id}?`);
                          if (confirmar) {
